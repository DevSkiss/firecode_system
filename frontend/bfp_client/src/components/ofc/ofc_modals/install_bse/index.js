  ...
  const submitBse = () => {
    if (resultBse != 0) {
      setPayments((payments) => [
        ...payments,
        {
          paymentName: "Installation of Building Service Equipment",
          firecode: "628-BFP-09",
          amount: Math.round(resultBse),
        },
      ]);
      handleClose2();
      ...
      >
        ...
        <Modal.Footer>
          <div className={styles.footer}>
            <p className={styles.textFooter}>P {Math.round(resultBse)}</p>
            <Button
              bsPrefix
