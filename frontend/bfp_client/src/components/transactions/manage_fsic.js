...
const ManageFSIC = () => {
    ...
    let approvedTransactions = filteredApprovedTransactions.map((txn) => {
        if (
          (txn.pe === "Approved" && txn.txnName === "FSIC Application for Business") ||
          (txn.pe === "Approved" && txn.txnName === "FSIC Application for Occupancy")
        ) {
          return (
            <tr key={txn._id}>
  ...
  return (
    <>
      <h1 className="text-center">Manage FSIC</h1>
      <h2>Approved</h2>
      <Row md={4}>
        <Col>
